...
shpjegim:
kërkon që të krijosh një program ulstr.c që ndërron gjendjen e shkronjave (uppercase → lowercase dhe lowercase → uppercase) dhe lë karakteret e tjera pa ndryshuar.
